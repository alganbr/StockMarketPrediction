...
if __name__ == '__main__':
	if len(sys.argv) == 1:
		...
		exit()
	symbol = sys.argv[1]
	djia_data = data_preparation.extract_stock_prices('../data/raw_data/stock_prices.csv', symbol)
	timestamps, tweets, sentiments = data_preparation.extract_naive_bayes_data('../data/naive_bayes_labeled_data/{}_tweets.csv'.format(symbol))
