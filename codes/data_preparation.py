...
def represent_data(symbol):
    djia_data = extract_stock_prices('../data/raw_data/stock_prices.csv', symbol)
    timestamps, tweets, sentiments = extract_naive_bayes_data('../data/naive_bayes_labeled_data/{}_tweets.csv'.format(symbol))
